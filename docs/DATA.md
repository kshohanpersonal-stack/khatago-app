...
4. Exported schemas (`app/schemas/com.khatago.finance.data.db.KhataGoDatabase/1.json`) are the diff tool.
   They are generated by the first real build (`./gradlew :app:kaptGenerateStubsDebugKotlin` triggers Room's
   schema export); if a committed schema and a generated one differ, the migration is wrong, and the diff is
   the review.
